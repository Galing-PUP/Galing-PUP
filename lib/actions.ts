...
export async function deleteUser(userId: string) {
  ...
  try {
    ...
    console.warn(
      'User might have already been deleted from DB or cascade is active:',
      error,
    )
  }
 ...
 * Reassigns any uploaded documents to the OWNER account before deletion.

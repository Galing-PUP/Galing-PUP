...
import { AiInsightResult, AiCitation, LlmResponse } from "@/types/ai-insights";
 ...
 */
export async function generateDocumentSummary(context: SummaryContext): Promise<string> {
...
function resolveCitations(llmOutput: LlmResponse, chunkMap: Map<number, any>): string {

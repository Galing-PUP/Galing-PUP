...
const ChartPlaceholder = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M0 15L10 10L20 18L30 12L40 20L50 15L60 25L70 20L80 22"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      <StatCard
        ...
        chart={<ChartPlaceholder className="text-red-500" />}
      />
      <StatCard
        icon={Users}
        title="Premium Users"
        ...
        chart={<ChartPlaceholder className="text-blue-500" />}
      />
      <StatCard
        icon={FileClock}
        ...
        chart={<ChartPlaceholder className="text-green-500" />}
      />
    </div>
  )
}

...
export function ViewPublicationModal({ item, isOpen, onClose, onAccept, onReject }: ViewPublicationModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-3xl">
        ...
        <DialogFooter className="pt-4 border-t">
          ...
          <Button onClick={() => onAccept(item.id)} variant="primary" shape="rounded">Accept</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );

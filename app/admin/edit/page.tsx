...
// 11/24/25 - Since there is no backend and view publications page yet, this isn't fully functional. To check the UI, use the mock publication IDs 1, 2, or 3 in the URL like so:
// http://localhost:3000/admin/edit?id=1
